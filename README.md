...
| **Testing**     | PowerShell persistence audit  | 495-test pre-commit gate                  |
...
├── tests/
│   └── check-persistence.ps1  Pre-commit 495-test persistence audit
...
git add -A
git commit          ← cache-bump guard runs first, then persistence audit (495 tests)
