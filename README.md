...
| **Testing**     | PowerShell persistence audit  | 386-test pre-commit gate                  |
...
├── tests/
│   └── check-persistence.ps1  Pre-commit 386-test persistence audit
...
git add -A
git commit          ← cache-bump guard runs first, then persistence audit (386 tests)
