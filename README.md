...
All unreleased work goes to **`dev`**; **`main` is release-only**. Each commit keeps docs + the 3002-test count in sync and bumps `CACHE_NAME` when a served file changes.
