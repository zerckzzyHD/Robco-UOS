...
| **Testing**     | PowerShell persistence audit  | 376-test pre-commit gate                  |
...
├── tests/
│   └── check-persistence.ps1  Pre-commit 376-test persistence audit
...
git add -A
git commit          ← cache-bump guard runs first, then persistence audit (376 tests)
