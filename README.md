...
| **Testing**     | PowerShell persistence audit  | 209-test pre-commit gate                  |
...
├── tests/
│   └── check-persistence.ps1  Pre-commit 209-test persistence audit
...
git add -A
git commit          ← persistence audit runs automatically (209 tests)
...
- 209-test automated persistence audit (DOM binding, Protocol 4 enforcement, migrateState mock execution, reputation 2D matrix, CRUD function existence, CAMPG tab DOM binding, campaignMode + playthroughType Protocol 4)
