...
(Protocol 4 doesn't apply), transcribed from `planning/2.9.0/data/FO3/KARMA_DATA.md`. Five pure engine functions
...
save-load fix — `planning/2.9.0/audits/AUDIT_registry_leak.md`):** before mapping the five
