...
- **A warning-surface inventory ran (2026-07-16)** — findings became the shipped read-side/UI-truthfulness fixes plus criteria folded into the 2.9.0 round. Full analysis: `planning/2.9.0/audits/WARNING_SURFACE_INVENTORY.md`.
...
**Done means:** none of the three flows can report success (or an innocent empty state) when the operation actually failed. Met. Source: `planning/2.9.0/audits/WARNING_SURFACE_INVENTORY.md`.
...
_Placed 2026-07-18 from two external AI reviews (`planning/2.9.0/audits/ATLAS_ECOSYSTEM_REVIEW.md` + the synthesis). Each new item below was checked against the real code before it earned its slot; where verification changed the scope, the verdict is stated inline._
...
**What it is.** The synthesis deliverable from the ecosystem cross-review (`planning/2.9.0/audits/ATLAS_ECOSYSTEM_SYNTHESIS.md`): a single generated representation of the whole system, offering **8 views over one graph** — and, load-bearing, the **assurance view is one of those eight** (generated FROM the test suite's structure so it can never drift from what's actually guarded). The governing rule from the synthesis: **generate everything a script can compute; hand-maintain only the un-derivable WHY.**
