...
const FALLOUT_REGISTRY = {
  ...
  //           skillReq:{skill,level}|null, dlc:null }
  recipes: [
    // ── Workbench ────────────────────────────────────────────────────────────
    {
      name: 'Stimpak',
      ...
      ingredients: [
        { item: 'Broc Flower', qty: 1 },
        { item: 'Empty Syringe', qty: 1 },
        { item: 'Xander Root', qty: 1 },
      ],
      skillReq: { skill: 'science', level: 70 },
      dlc: null,
    },
    {
      name: 'Super Stimpak',
      station: 'workbench',
      output: { item: 'Super Stimpak', qty: 1 },
      ingredients: [
        { item: 'Leather Belt', qty: 1 },
        { item: 'Mutfruit', qty: 1 },
        { item: 'Nuka-Cola', qty: 1 },
        { item: 'Stimpak', qty: 1 },
      ],
      skillReq: { skill: 'science', level: 90 },
      dlc: null,
    },
    {
      name: "Doctor's Bag",
      station: 'workbench',
      output: { item: "Doctor's Bag", qty: 1 },
      ingredients: [
        { item: 'Forceps', qty: 1 },
      ...
      skillReq: { skill: 'medicine', level: 40 },
      dlc: null,
    },
    {
      ...
      ingredients: [
        { item: 'Duct Tape', qty: 1 },
        { item: 'Scrap Electronics', qty: 1 },
        { item: 'Scrap Metal', qty: 2 },
    ...
    {
      name: 'Auto-Inject Stimpak',
      station: 'workbench',
      output: { item: 'Auto-Inject Stimpak', qty: 1 },
      ingredients: [
        { item: 'Sensor Module', qty: 1 },
        { item: 'Stimpak', qty: 1 },
      ],
      skillReq: { skill: 'science', level: 75 },
      dlc: null,
    },
    {
      name: 'Bottlecap Mine',
      ...
      ingredients: [
        { item: 'Bottle Caps', qty: 10 },
        { item: 'Cherry Bomb', qty: 5 },
        { item: 'Lunchbox', qty: 1 },
        { item: 'Sensor Module', qty: 1 },
      ],
      skillReq: { skill: 'explosives', level: 75 },
      dlc: null,
    },
    {
      name: 'Gas Bomb',
      station: 'workbench',
      output: { item: 'Gas Bomb', qty: 1 },
      ingredients: [
        { item: 'Sensor Module', qty: 1 },
        { item: 'Duct Tape', qty: 1 },
      ...
      skillReq: { skill: 'explosives', level: 40 },
      dlc: null,
    },
    {
      name: 'Nuka-Cola Quartz',
      station: 'workbench',
      output: { item: 'Nuka-Cola Quartz', qty: 1 },
      ingredients: [{ item: 'Nuka-Cola', qty: 3 }],
      skillReq: { skill: 'science', level: 90 },
      dlc: null,
    },
    {
      ...
      station: 'workbench',
      output: { item: 'Nuka-Cola Victory', qty: 1 },
      ingredients: [{ item: 'Nuka-Cola', qty: 3 }],
      skillReq: { skill: 'science', level: 90 },
      dlc: null,
    },
    {
      ...
      station: 'workbench',
      output: { item: 'Ice Cold Nuka-Cola', qty: 2 },
      ingredients: [{ item: 'Nuka-Cola', qty: 3 }],
      skillReq: { skill: 'science', level: 90 },
      dlc: null,
    },
    {
      ...
      station: 'workbench',
      output: { item: 'Cosmic Knife (Super Heated)', qty: 1 },
      ingredients: [
        { item: 'Cosmic Knife', qty: 1 },
        { item: 'Forceps', qty: 1 },
        { item: 'Pilot Light', qty: 1 },
      ],
      skillReq: { skill: 'repair', level: 35 },
      dlc: null,
    },
    {
      name: 'Coyote Hide Belt',
      station: 'workbench',
      output: { item: 'Leather Belt', qty: 2 },
      ingredients: [{ item: 'Coyote Hide', qty: 1 }],
      skillReq: { skill: 'repair', level: 15 },
      dlc: null,
    },
    {
      name: 'Dog Hide Belt',
      station: 'workbench',
      output: { item: 'Leather Belt', qty: 1 },
      ingredients: [{ item: 'Dog Hide', qty: 1 }],
      skillReq: { skill: 'repair', level: 5 },
      dlc: null,
    },
    // ── Workbench — Recycling (output.ammo: true) ─────────────────────────────
    {
      name: 'Recycle Energy Cell',
      station: 'workbench',
      output: { item: 'Energy Cell', qty: 4, ammo: true },
      ingredients: [{ item: 'Drained Small Energy Cell', qty: 4 }],
      skillReq: { skill: 'science', level: 10 },
      dlc: null,
    },
    {
      name: 'Recycle Microfusion Cell',
      station: 'workbench',
      output: { item: 'Microfusion Cell', qty: 4, ammo: true },
      ingredients: [{ item: 'Drained Microfusion Cell', qty: 4 }],
      skillReq: { skill: 'science', level: 25 },
      dlc: null,
    },
    {
      name: 'Recycle Electron Charge Pack',
      station: 'workbench',
      output: { item: 'Electron Charge Pack', qty: 4, ammo: true },
      ingredients: [{ item: 'Drained Electron Charge Pack', qty: 4 }],
      skillReq: { skill: 'science', level: 40 },
      dlc: null,
    },
    {
      name: 'Recycle Flamer Fuel',
      station: 'workbench',
      output: { item: 'Flamer Fuel', qty: 4, ammo: true },
      ingredients: [{ item: 'Drained Flamer Fuel Tank', qty: 4 }],
      skillReq: { skill: 'science', level: 15 },
      dlc: null,
    },
    // ── Campfire ─────────────────────────────────────────────────────────────
    {
      name: 'Antivenom',
      station: 'campfire',
      output: { item: 'Antivenom', qty: 2 },
      ingredients: [
        { item: 'Nightstalker Blood', qty: 1 },
        { item: 'Radscorpion Poison Gland', qty: 2 },
      ],
      skillReq: { skill: 'survival', level: 40 },
      dlc: null,
    },
    {
      name: 'Bitter Drink',
      station: 'campfire',
      output: { item: 'Bitter Drink', qty: 1 },
      ingredients: [
        { item: 'Broc Flower', qty: 1 },
        { item: 'Xander Root', qty: 1 },
        { item: 'Empty Sunset Sarsaparilla Bottle', qty: 1 },
      ],
      skillReq: { skill: 'survival', level: 15 },
      dlc: null,
    },
    {
      name: 'Datura Antivenom',
      station: 'campfire',
      output: { item: 'Datura Antivenom', qty: 1 },
      ingredients: [
        { item: 'Broc Flower', qty: 1 },
        { item: 'Sacred Datura Root', qty: 1 },
        { item: 'Spore Plant Pods', qty: 1 },
        { item: 'Xander Root', qty: 1 },
      ],
      skillReq: { skill: 'survival', level: 25 },
      dlc: null,
    },
    {
      name: 'Daturana',
      station: 'campfire',
      output: { item: 'Daturana', qty: 1 },
      ingredients: [
        { item: 'Flour', qty: 1 },
        { item: 'Purified Water', qty: 1 },
        { item: 'Sacred Datura Root', qty: 1 },
      ],
      skillReq: { skill: 'survival', level: 65 },
      dlc: null,
    },
    {
      name: 'Fiery Purgative',
      station: 'campfire',
      output: { item: 'Fiery Purgative', qty: 1 },
      ingredients: [
        { item: 'Jalapeño Pepper', qty: 1 },
        { item: 'Vodka', qty: 1 },
        { item: 'White Horsenettle', qty: 1 },
      ],
      skillReq: { skill: 'survival', level: 25 },
      dlc: null,
    },
    {
      ...
      station: 'campfire',
      output: { item: 'Snakebite Tourniquet', qty: 1 },
      ingredients: [
        { item: 'Buffalo Gourd Seed', qty: 1 },
        { item: 'Surgical Tubing', qty: 1 },
      ],
      skillReq: { skill: 'survival', level: 30 },
      dlc: null,
    },
    {
      name: 'Mass Purified Water',
      station: 'campfire',
      output: { item: 'Purified Water', qty: 4 },
      ingredients: [{ item: 'Dirty Water', qty: 5 }],
      skillReq: { skill: 'survival', level: 50 },
      dlc: null,
    },
    {
      name: 'Healing Powder',
      station: 'campfire',
      output: { item: 'Healing Powder', qty: 1 },
      ingredients: [
        { item: 'Broc Flower', qty: 1 },
        { item: 'Xander Root', qty: 1 },
      ],
  ...
  // ── BREAKDOWNS ────────────────────────────────────────────────────────────
  // Ammo breakdown yields the brass/hull case; cookware scraps to Scrap Metal.
  // Schema: { item, yields:[{item,qty}], skillReq:null }
  breakdowns: [
    { item: '.357 Magnum Round', yields: [{ item: 'Case, .357 Magnum', qty: 1 }], skillReq: null },
    { item: '.44 Magnum Round', yields: [{ item: 'Case, .44 Magnum', qty: 1 }], skillReq: null },
    { item: '.45 Auto Round', yields: [{ item: 'Case, .45 Auto', qty: 1 }], skillReq: null },
    { item: '9mm Round', yields: [{ item: 'Case, 9mm', qty: 1 }], skillReq: null },
    { item: '10mm Round', yields: [{ item: 'Case, 10mm', qty: 1 }], skillReq: null },
    { item: '5.56mm Round', yields: [{ item: 'Case, 5.56mm', qty: 1 }], skillReq: null },
    { item: '5mm Round', yields: [{ item: 'Case, 5mm', qty: 1 }], skillReq: null },
    { item: '.308 Round', yields: [{ item: 'Case, .308', qty: 1 }], skillReq: null },
    { item: '.50 MG Round', yields: [{ item: 'Case, .50 MG', qty: 1 }], skillReq: null },
    {
      item: '12 Gauge Shotgun Shell',
      yields: [{ item: 'Hull, 12 Gauge', qty: 1 }],
      skillReq: null,
    },
    { item: 'Metal Cooking Pot', yields: [{ item: 'Scrap Metal', qty: 1 }], skillReq: null },
