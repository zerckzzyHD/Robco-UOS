...
const FALLOUT_REGISTRY = {
  ...
  locations: [
    ...
    { name: 'Georgtown West', type: 'other' },
  ...
  collectibles: [
    { name: 'Strength', stat: 's', boost: 1, location: "MEGATON — LUCAS SIMMS' HOUSE" },
    { name: 'Perception', stat: 'p', boost: 1, location: 'REPUBLIC OF DAVE' },
    { name: 'Endurance', stat: 'e', boost: 1, location: 'DEATHCLAW SANCTUARY' },
    { name: 'Charisma', stat: 'c', boost: 1, location: 'VAULT 108 — CLONING LAB' },
    { name: 'Intelligence', stat: 'i', boost: 1, location: 'RIVET CITY — SCIENCE LAB' },
    { name: 'Agility', stat: 'a', boost: 1, location: 'GREENER PASTURES DISPOSAL SITE' },
    { name: 'Luck', stat: 'l', boost: 1, location: 'ARLINGTON CEMETERY NORTH' },
    { name: 'Barter', stat: 'barter', boost: 10, location: 'EVERGREEN MILLS — BAZAAR' },
    { name: 'Big Guns', stat: 'big_guns', boost: 10, location: 'FORT CONSTANTINE — CO QUARTERS' },
    { name: 'Energy Weapons', stat: 'energy_weapons', boost: 10, location: 'RAVEN ROCK — LEVEL 2' },
    { name: 'Explosives', stat: 'explosives', boost: 10, location: 'MINEFIELD — HOUSE #103' },
    { name: 'Lockpick', stat: 'lockpick', boost: 10, location: 'BETHESDA RUINS — OFFICES EAST' },
    { name: 'Medicine', stat: 'medicine', boost: 10, location: "VAULT 101 — OVERSEER'S OFFICE" },
    { name: 'Melee Weapons', stat: 'melee_weapons', boost: 10, location: 'DUNWICH BUILDING' },
    { name: 'Repair', stat: 'repair', boost: 10, location: 'AREFU' },
    { name: 'Science', stat: 'science', boost: 10, location: 'VAULT 106 — LIVING QUARTERS' },
    {
      name: 'Small Guns',
      stat: 'small_guns',
      boost: 10,
    ...
    { name: 'Sneak', stat: 'sneak', boost: 10, location: 'YAOGUAI TUNNELS' },
    { name: 'Speech', stat: 'speech', boost: 10, location: "PARADISE FALLS — EUOLOGY'S PAD" },
