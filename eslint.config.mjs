  ...
  js.configs.recommended,
  {
    languageOptions: {
      ...
      globals: {
        ...
        // 2.8.5 item 6 — Schematic View proxies, per-game framing, value re-sync
        _schemForwardCheckbox: 'readonly',
        _schemForwardValue: 'readonly',
        _schemForwardClick: 'readonly',
        _schemCloneOptions: 'readonly',
        _schemChipRows: 'readonly',
        _schematicFraming: 'readonly',
        _applySchematicFraming: 'readonly',
        _syncBayValueControls: 'readonly',
        _applyBayView: 'readonly',
