...
git add -A
git commit          # Pre-commit hook: 203 tests must pass
git push origin main
```

- **203 tests must pass.** If fewer pass, something is broken. Investigate before committing.
...
- [ ] Run `git commit` — 203 tests must pass
...
- [ ] Lint, format, commit (203 tests) → Protocol 2
